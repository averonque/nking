...
3. To calculate the monthly loan payments using simple interest. Use the formula: monthly_payment = ((loan_amount * ((repayment_duration_months / 12) * interest_rate_decimal)) + loan_amount). monthly_payment = monthly_payment /  repayment_duration_months Return the result as a number with two decimal places. Dont write the formula in the document just remember the final output
